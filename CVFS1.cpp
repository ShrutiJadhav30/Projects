...
void man(char *name)
{
    ...
    if(strcmp(name,"create")==0)
    {
        ...
        printf("Usage:create File_name Premission\n");
    }
    else if(strcmp(name,"read")==0)
    {
      printf("Description: Used to read data from  new regular file\n");
      printf("Usage:read File_name No_Of_Bytes_To_Read\n");   
    }
    else if(strcmp(name,"write")==0)
    {
      printf("Description: Used to write into new regular file\n");
...
void DisplayHelp()
{
    printf("Is:To List all Files\n");
    printf("clear:To clear console\n");
    printf("open:To open the file\n");
    printf("close:To close the file\n");
    printf("closeall:To close all opened files\n");
    printf("read:To Read the contents from file\n");
    printf("write:To Write contents to files\n");
...
int main()
{
    ...
    while(1)
    {
        ...
        count=sscanf(str,"%s %S %s %s",command[0],command[1],command[3]);
    ...
    else if(strcmp(command[0],"write")==0)
    {
        ...
        if(ret==-2)
        printf("ERROE: Ther is no sufficient memory to write\n");
        if(ret==-3)
...
else if(count==3)
{
    ...
    else if(count==4)
    {
        if(strcmp(command[0],"lSeek")==0)
        {
            ...
            if(ret==-1)
            {
                printf("ERROR: Unable tonperform lseek\n");
            }
            else
            {
